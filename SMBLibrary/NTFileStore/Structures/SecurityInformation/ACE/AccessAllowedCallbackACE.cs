...
namespace SMBLibrary
{
    ...
    /// [MS-DTYP] 2.4.4.6
    /// </summary>
    public class AccessAllowedCallbackACE : ACE
    {
        ...
        public AccessAllowedCallbackACE()
        {
            ...
            Header.AceType = AceType.ACCESS_ALLOWED_CALLBACK_ACE_TYPE;
            ApplicationData = new byte[0];
        }

        public AccessAllowedCallbackACE(byte[] buffer, int offset)
        {
