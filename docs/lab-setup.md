# SMB and DFS Test Lab Setup

This guide shows how to stand up a reproducible lab to test SMB and DFS with SMBLibrary. It offers three paths:
...
Security references: [Protect SMB from interception][ms-smb-interception], [SMB security][ms-smb-security].
...
- **Cost considerations**
  ...
  - Use the official [Azure pricing calculator](https://azure.microsoft.com/pricing/calculator/) to estimate costs for your region and usage pattern.
...
- [Detailed Hyper-V lab setup](lab-setup-hyperv.md) — Step-by-step Windows Server 2022 lab with DFS Namespaces and Replication
- [Codebase patterns](codebase-patterns.md) — Architecture and code style guide
