...
{
    public class TestSMB1Client : SMB1Client
    {
    ...
    public class SMB1ConnectTests
    {
        ...
        {
            // Setup test server on a random port (with SMB1 enabled)
            ...
            m_server.Start(IPAddress.Loopback, SMBTransportType.DirectTCPTransport, m_serverPort, true, true, false, null);
        }
        ...
        {
            // Arrange
            TestSMB1Client client = new TestSMB1Client();
        ...
        public void When_ConnectWithIPAddressAndPortZero_ShouldUseDefaultPort445()
        {
            ...
            try
            {
                ...
                defaultPortServer.Start(IPAddress.Loopback, SMBTransportType.DirectTCPTransport, expectedDefaultPort, true, true, false, null);
                serverStarted = true;
            }
